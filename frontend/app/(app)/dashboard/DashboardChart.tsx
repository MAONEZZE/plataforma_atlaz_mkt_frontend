...
const SERIES = [
  { key: "ligacoes_agendadas", label: "Lig. Agendadas", color: "var(--chart-1)" },
  { key: "ligacoes_realizadas", label: "Lig. Realizadas", color: "var(--chart-2)" },
  { key: "reunioes_agendadas", label: "Reuniões", color: "var(--chart-3)" },
  { key: "indicacoes", label: "Indicações", color: "var(--chart-4)" },
] as const;
...
export function DashboardChart() {
  ...
  const chartData = data.map((d) => ({
    ...d,
    semana: format(parseISO(d.semana), "dd/MM", { locale: ptBR }),
  }));
